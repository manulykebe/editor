...
export const NodeDialog = ({ isOpen, onClose, onSave, initialData, availableScripts }: NodeDialogProps) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    const scriptPath = isNewScript ? `${crypto.randomUUID()}/f.js` : selectedScript;
